...
export default function AccountPage(){
 ...
 if(!cancelled){if(s.error)alert(s.error.message);if(r.error)alert(r.error.message);setSaved((s.data??[]) as unknown as Saved[]);setRatings((r.data??[]) as unknown as Rating[]);setLoading(false);}})();return()=>{cancelled=true}},[router,supabase]);
