  ...
  return (
    <nav className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3">
      ...
      <div className="flex flex-wrap items-center gap-1 sm:gap-3">
        ...
        {!loading && user && <Link href="/account" className="inline-flex rounded-lg px-3 py-2 text-sm font-medium text-slate-300 transition hover:bg-indigo-500/10 hover:text-indigo-200">Account</Link>}
