...
export default function LumaDeveloperPortal() {
  ...
  return (
    <div className="glass-page mx-auto max-w-6xl space-y-8 pb-20">
      ...
      <section className="grid gap-4 sm:grid-cols-3"><Link href="/dashboard/analytics" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 transition hover:border-indigo-400/40"><h2 className="font-semibold text-white">Analytics</h2><p className="mt-1 text-sm text-slate-400">Downloads, platforms, top apps and funding clicks.</p></Link><Link href="/dashboard/profile" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 transition hover:border-indigo-400/40"><h2 className="font-semibold text-white">Developer profile</h2><p className="mt-1 text-sm text-slate-400">Bio, avatar, website and source-hosting links.</p></Link><Link href="/dashboard/funding" className="rounded-2xl border border-slate-800 bg-slate-900/60 p-5 transition hover:border-indigo-400/40"><h2 className="font-semibold text-white">Developer funding</h2><p className="mt-1 text-sm text-slate-400">Manage support methods for all of your apps.</p></Link></section>
